...
import { IProduct } from './bai4.component.interface';
...
export class Bai4Component implements OnInit {
  ...
  render(callback: any) {
    let innerHTML = this.products.map(product => {
      return `<tr>
    <td><img style="height: 64px; width: 64px" class="p-1" src=${product.imageUrl}></td>
